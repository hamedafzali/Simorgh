...
const UserMonitoring = () => {
  ...
  return (
    <div>
      ...
      {userStats.total === 0 && users.length === 0 && onlineUsers.length === 0 && (
        <Alert
          type="warning"
          showIcon
          style={{ marginBottom: 24 }}
          message="User monitoring is unavailable"
          description="No User model or user records are available in the backend yet. This page will remain mostly empty until user tracking is implemented."
        />
      )}
      ...
      <Card title="All Users">
        <Table
          ...
          scroll={{ x: 1200 }}
          locale={{ emptyText: <Empty description="No users available" /> }}
        />
      </Card>
